...
class AppWidget(QWidget):
    def __init__(self, parent):
        ...
        # *********************************************************************************************
        # Define QPushButtons
        self.pushButton_EEG_start = QPushButton(
            self.language["pushButton_EEG_start"][self.language_current], self.tab_EEG
        )
        ...
        self.pushButton_EEG_stop = QPushButton(
            self.language["pushButton_EEG_stop"][self.language_current], self.tab_EEG
        )
        ...
        self.pushButton_EEG_Model_process_raw_data.clicked.connect(
            self.on_pushButton_EEG_start_clicked
        )
        ...
        self.pushButton_EEG_Model_add_class_label.clicked.connect(
            self.on_pushButton_EEG_start_clicked
        )

        self.pushButton_EEG_Model_train = QPushButton(
            self.language["pushButton_EEG_Model_train"][self.language_current], self.tab_EEG_Model
        )
        ...
        self.pushButton_EEG_Model_test = QPushButton(
            self.language["pushButton_EEG_Model_test"][self.language_current], self.tab_EEG_Model
        )
        ...
        self.pushButton_EEG_Model_result = QPushButton(
            self.language["pushButton_EEG_Model_result"][self.language_current], self.tab_EEG_Model
        )
        ...
        self.label_EEG_Model_select.setText(
            self.language["label_EEG_Model_select"][self.language_current]
        )
        ...
        # *********************************************************************************************
        # Define QPushButtons
        self.pushButton_camera_open = QPushButton(
            self.language["pushButton_camera_open"][self.language_current], self.tab_Camera
        )
        self.pushButton_camera_open.setGeometry(QRect(400, 50, 150, 50))
        self.pushButton_camera_open.setFont(self.font)

        self.pushButton_camera_close = QPushButton(
            self.language["pushButton_camera_close"][self.language_current], self.tab_Camera
        )
        ...
        # Define QCheckBox
        self.checkBox_face_detect = QCheckBox(
            self.language["checkBox_face_detect"][self.language_current], self.tab_Camera
        )
    ...
    def on_combo_language_changed(self):
        ...
        # TAB EEG
        self.pushButton_EEG_start.setText(
            self.language["pushButton_EEG_start"][self.language_current]
        )
        self.pushButton_EEG_stop.setText(
            self.language["pushButton_EEG_stop"][self.language_current]
        )
        # TAB EEG Model
        self.pushButton_EEG_Model_process_raw_data.setText(
            self.language["pushButton_EEG_Model_process_raw_data"][self.language_current]
        )
        self.pushButton_EEG_Model_add_class_label.setText(
            self.language["pushButton_EEG_Model_add_class_label"][self.language_current]
        )
        self.pushButton_EEG_Model_train.setText(
            self.language["pushButton_EEG_Model_train"][self.language_current]
        )
        self.pushButton_EEG_Model_test.setText(
            self.language["pushButton_EEG_Model_test"][self.language_current]
        )
        self.pushButton_EEG_Model_result.setText(
        ...
        # TAB Camera
        self.pushButton_camera_open.setText(
            self.language["pushButton_camera_open"][self.language_current]
        )
        self.pushButton_camera_close.setText(
            self.language["pushButton_camera_close"][self.language_current]
        )
        self.checkBox_face_detect.setText(
            self.language["checkBox_face_detect"][self.language_current]
        )
    ...
    def update_plot(self):
        ...
        if self.plot_nUser == "Load_initial_value":
            ...
            filename = self.cf["raw_data_eeg_path"] + "s" + f"{self.plot_nUser:02d}" + ".dat"
            f = open(filename, "rb")
        ...
        if self.plot_nTime + self.cf["nTime_step"] < self.cf["nTime_end"]:
            self.canvas_time.plot_time(
                eeg=self.plot_eeg, tr=self.plot_nTrial, i=self.plot_nTime, cf=self.cf
            )
            ...
            if self.plot_nTrial < self.cf["nTrial_test_end"] - 1:
                ...
                if self.plot_nUser < self.cf["nUser_test_end"]:
                    ...
                    filename = (
                        self.cf["raw_data_eeg_path"] + "s" + f"{self.plot_nUser:02d}" + ".dat"
                    )
                    f = open(filename, "rb")
                    self.plot_eeg = pickle.load(f, encoding="latin1")
    ...
    def update_frame(self):
        ...
        if self.checkBox_face_detect.isChecked() == True:
            ...
            cv2.rectangle(
                self.frame,
                (self.xBox[0], self.xBox[1]),
                (self.xBox[0] + self.xBox[2], self.xBox[1] + self.xBox[3]),
                (0, 255, 0),
                2,
            )
...
class Canvas(FigureCanvas):
    ...
    def plot_time(self, eeg, tr, i, cf):
        ...
        for ch in cf["nChannel_ON"]:
            ...
            ax.plot(
                np.array(list(range(cf["nTime_step"]))),
                eeg["data"][tr][cf["nChannel_ON"][ch]][i : i + cf["nTime_step"]],
                label=ch,
                color="C" + str(j),
            )
            ax.set_ylabel(ch)
    ...
    def plot_fft(self, eeg, tr, i, cf):
        ...
        for ch in cf["nChannel_ON"]:
            ...
            fft_values = np.absolute(
                np.fft.rfft(data)
            )  # Real amplitudes of FFT (only in postive frequencies)
